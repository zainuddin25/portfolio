    ...
    return (
        <div className="w-full bg-black">
            <div className="container px-10 py-10 mx-auto lg:px-0 md:px-0">
                ...
                <div className="flex-col mt-10 lg:flex-row lg:flex lg:items-center">
                    <div className="w-full lg:w-2/4 lg:px-16">
                        <h1 className="mt-8 text-4xl font-bold text-white lg:mt-0 font-poppins">Hi, Iam RifAn</h1>
                        <p className="mt-4 text-sm font-light lg:mt-2 text-slate-500 font-poppins">
